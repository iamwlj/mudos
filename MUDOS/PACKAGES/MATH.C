...
f_cos PROT((void))
{
    sp->u.real = (LPC_FLOAT)cos(sp->u.real);
}
#endif
...
f_sin PROT((void))
{
    sp->u.real = (LPC_FLOAT)sin(sp->u.real);
}
#endif
#ifdef F_TAN
void
f_tan PROT((void))
{
     ...
     */
    sp->u.real = (LPC_FLOAT)tan(sp->u.real);
}
#endif
...
f_asin PROT((void))
{
    ...
    sp->u.real = (LPC_FLOAT)asin(sp->u.real);
}
#endif
...
f_acos PROT((void))
{
    ...
    sp->u.real = (LPC_FLOAT)acos(sp->u.real);
}
#endif
...
f_atan PROT((void))
{
    sp->u.real = (LPC_FLOAT)atan(sp->u.real);
}
#endif
...
f_log PROT((void))
{
    ...
    sp->u.real = (LPC_FLOAT)log(sp->u.real);
}
#endif
...
f_pow PROT((void))
{
    ...
    (sp - 1)->u.real = (LPC_FLOAT)pow(val, val2);
    sp--;
    sp->type = T_REAL;
}
#endif
...
f_exp PROT((void))
{
    sp->u.real = (LPC_FLOAT)exp(sp->u.real);
}
#endif
...
f_floor PROT((void))
{
    sp->u.real = (LPC_FLOAT)floor(sp->u.real);
}
#endif
...
f_ceil PROT((void))
{
    sp->u.real = (LPC_FLOAT)ceil(sp->u.real);
}
#endif
